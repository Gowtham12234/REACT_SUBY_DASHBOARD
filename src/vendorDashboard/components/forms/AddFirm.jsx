...
const AddFirm = ({ShowLoginHandler}) => {
  ...
  const handlefirmSubmit=async(e)=>{
    ...
    try {
      ...
      if(!loginToken){
        ...
        alert("complete the log in process first");
      ...
      const formData=new FormData();
        ...
        if(response.ok){
          ...
          alert("firm exists . only one firm should be added with a one login id")
        }else{
  ...
  return (
    <>
        <div className="firmSection">
                ...
                <form action=""className='tableForm' onSubmit={handlefirmSubmit}>
                    <h3> Add Firm </h3>
                <label htmlFor=""> FirmName</label>
    ...
    <div className="checkInp">
      <label >Region</label>
          ...
          <div className="regBoxContainer">
                ...
                <input type="file" onChange={handleImagepload}/><br />
